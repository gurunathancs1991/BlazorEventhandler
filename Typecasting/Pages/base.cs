...
namespace Typecasting
{
    public class Base: ComponentBase
    {
        ...
        //[JSInvokable]
        //public virtual object Trigger(string eventName, string arg)
        //{

        //    EventData data = this.DelegateList[eventName];
        //    EventCallback<object> BoolChanged = (EventCallback<object>)(object)data.Handler;
        //    BoolChanged.InvokeAsync(arg);
        //    return arg;
